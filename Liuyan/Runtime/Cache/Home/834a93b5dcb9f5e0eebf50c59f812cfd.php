 ...
 t_nav();
        ...
        <div class="layui-body">
            ...
            <div style="padding: 15px;">
                <table class="layui-table" lay-data="{url:'/liuyan.php?c=liuyan&a=getliuyan&hospital=2',page:true,limit:15}" lay-filter="demo">
                    <thead>
                        <tr>
<!--                             <th lay-data="{field:'id',event:'detail', width:60, sort: true}">ID</th> -->
    ...
    <script type="text/html" id="bsTpl">
        {{# if(d.bs === '1'){ }}
        <span>竞价</span> {{# } else { }}<span style="color:red;">外围</span> {{# } }}
    </script>
