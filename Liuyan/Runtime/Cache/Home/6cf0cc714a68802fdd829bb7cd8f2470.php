 ...
 t_nav();
        ...
        <div class="layui-body">
            ...
            <div style="padding: 15px;">
                <table class="layui-table" lay-data="{url:'/liuyan.php?c=liuyan&a=getliuyan',page:true,limit:15}" lay-filter="demo">
                    <thead>
                        <tr>
                            ...
                            <th lay-data="{field:'height',event:'detail', width:60}">身高</th>
                            ...
                            <th lay-data="{field:'tjtime', event:'detail',width:160}">提交时间</th>
                            <th lay-data="{field:'suburl', event:'detail',width:100}">提交地址</th>
